...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-07 13:34`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b307d8d9-e160-4e6f-a3ec-4eb5415ddc48.git
$ cd b307d8d9-e160-4e6f-a3ec-4eb5415ddc48
```
